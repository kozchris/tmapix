 ...
 * @version $Rev:$ - $Date:$
 */
public class SidFunction implements Function {
    ...
    public static Topic evaluate(Context ctx, String arg)
            throws FunctionCallException {
        TopicMap tm = FunctionUtils.getTopicMap(ctx.getNodeSet());
        return tm.getTopicBySubjectIdentifier(tm.createLocator(arg));
    }
