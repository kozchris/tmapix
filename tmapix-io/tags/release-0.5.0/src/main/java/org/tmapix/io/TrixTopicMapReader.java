 ...
 * @version $Rev$ - $Date$
 */
public final class TrixTopicMapReader extends AbstractRDFTopicMapReader {
     ...
     */
    public TrixTopicMapReader(final TopicMap topicMap, final File source, final String docIRI) throws IOException {
        super(topicMap, Syntax.TRIX, source, docIRI);
    }
     ...
     * @throws IOException If an error occurs. 
     */
    public TrixTopicMapReader(final TopicMap topicMap, final File source) throws IOException {
        super(topicMap, Syntax.TRIX, source);
    }
     ...
     * @param docIRI The document IRI which is used to resolve IRIs against.
     */
    public TrixTopicMapReader(final TopicMap topicMap, final InputStream source, final String docIRI) {
        super(topicMap, Syntax.TRIX, source, docIRI);
    }
     ...
     */
    public TrixTopicMapReader(final TopicMap topicMap, final Source source) {
        super(topicMap, Syntax.TRIX, source);
    }
