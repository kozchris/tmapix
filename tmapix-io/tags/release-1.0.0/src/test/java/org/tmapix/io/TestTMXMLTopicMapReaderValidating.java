...
public class TestTMXMLTopicMapReaderValidating extends AbstractValidCXTMReaderTestCase {

    public TestTMXMLTopicMapReaderValidating(File file, String inputDir, String referenceDir, boolean convertToTMDM) {
