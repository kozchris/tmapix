...
public final class XTM10Utils {
     ...
     */
    private static void _replaceSubjectIdentifier(final TopicMap topicMap, final String source, final String target) {
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(source), 
                topicMap.createLocator(target));
    }
