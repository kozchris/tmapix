...
public class TestCTMTopicMapReaderInvalid extends AbstractInvalidCXTMReaderTestCase {

    public TestCTMTopicMapReaderInvalid(final File file) {
        super(file);
    }
    ...
    protected TopicMapReader makeReader(final TopicMap tm, final String iri)
            throws Exception {
        final CTMTopicMapReader reader = new CTMTopicMapReader(tm, new URL(iri).openStream(), iri);
        return reader;
    }
