...
public class XTM10Utils {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XTM10Utils.class.getName());
    ...
    public static void convertXTM10PSIs(final TopicMap topicMap) {
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.CLASS_INSTANCE), topicMap.createLocator(TMDM.TYPE_INSTANCE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.CLASS), topicMap.createLocator(TMDM.TYPE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.INSTANCE), topicMap.createLocator(TMDM.INSTANCE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.SUPERCLASS_SUBCLASS), topicMap.createLocator(TMDM.SUPERTYPE_SUBTYPE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.SUPERCLASS), topicMap.createLocator(TMDM.SUPERTYPE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.SUBCLASS), topicMap.createLocator(TMDM.SUBTYPE));
        _replaceSubjectIdentifier(topicMap, topicMap.createLocator(XTM10.SORT), topicMap.createLocator(TMDM.SORT));
    }
