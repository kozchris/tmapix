...
import com.semagia.tmapix.index.impl.TinyTimIdentityIndex;
 ...
 * @version $Rev$ - $Date$
 */
public class TestTinyTimIdentityIndex extends AbstractIdentityIndexTestCase {

    public static void main(String[] args) {
        junit.awtui.TestRunner.run(TestTinyTimIdentityIndex.class);
    }
